...
def savedb():
   ...
   db.solution.update_one({'name':name_receive},{'$set':{'solution':sol_receive}})
   return jsonify({'result': 'success'})
...
def savereserve():
   ...
   print(date_receive)
   db.solution.update_one({'name':reserve_receive},{'$set':{'year':date_receive}})
   return jsonify({'result': 'success'})
...
def deletereserve():
   ...
   db.solution.update_one({'name':reserve_receive},{'$set':{'year':'예약 미완료'}})
   return jsonify({'result': 'success'})
